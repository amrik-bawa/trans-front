...
const RecentEnquries=()=>{


    // const enquiriesName = useSelector((state) => state.enquiries.name)

    // const dispatch = useDispatch()
    // const { enquriesList } = useSelector((state) => state.enquiries)
        ...
        <div className="mt-3 border-lightgray  py-2 px-2 " style={{border:'2px solid red'}}>
                                                    <div className="d-lg-flex justify-content-between">
                                                        <div className="d-flex align-items-center">
                                                            <h3 className="fw-bold fs-18 mb-0">Recent dddddddddEnquiries</h3>
                                                            <div className="ms-1">
